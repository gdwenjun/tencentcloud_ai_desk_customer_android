...
public class CustomerServiceProfileLayout extends LinearLayout implements View.OnClickListener, IFriendProfileLayout {
    ...
    private void init() {
        ...
        mTitleBar.setTitle(getResources().getString(com.tencent.qcloud.tuikit.deskcontact.R.string.profile_detail), ITitleBarLayout.Position.MIDDLE);
    ...
    private void setViewContentFromItemBean(ContactItemBean data) {
        ...
        if (TextUtils.isEmpty(mContactInfo.getSignature())) {
            mSignatureTagView.setText(getResources().getString(com.tencent.qcloud.tuikit.deskcontact.R.string.contact_no_status));
        } else {
            mSignatureTagView.setText(getResources().getString(com.tencent.qcloud.tuikit.deskcontact.R.string.contact_signature_tag));
        }
        int radius = getResources().getDimensionPixelSize(com.tencent.qcloud.tuikit.deskcontact.R.dimen.contact_profile_face_radius);
    ...
    public void onClick(View v) {
        if (v == clearMessageBtn) {
            new TUIKitDialog(getContext())
                ...
                .setTitle(getContext().getString(com.tencent.qcloud.tuikit.deskcontact.R.string.clear_msg_tip))
