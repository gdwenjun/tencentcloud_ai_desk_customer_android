...
public class TasksBranchReplyView  extends TUIReplyQuoteView<TasksBranchMessageReplyQuoteBean> {
    private TextView textView;

    public TasksBranchReplyView(Context context) {
        super(context);
        textView = findViewById(R.id.text_quote_tv);
    }

    @Override
    public void onDrawReplyQuote(TasksBranchMessageReplyQuoteBean quoteBean) {
