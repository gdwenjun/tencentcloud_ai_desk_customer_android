...
public class ReplyPreviewView extends FrameLayout {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.desk_chat_minimalist_reply_preview_layout, this);
    ...
    private void loadAvatar(ImageView imageView, Object url) {
        ...
        RequestBuilder<Drawable> errorRequestBuilder = Glide.with(getContext())
            .load(com.tencent.qcloud.tuikit.deskcommon.R.drawable.core_default_user_icon_light)
