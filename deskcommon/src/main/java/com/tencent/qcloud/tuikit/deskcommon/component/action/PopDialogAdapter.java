package com.tencent.qcloud.tuikit.deskcommon.component.action;
...
public class PopDialogAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(TUIConfig.getAppContext()).inflate(R.layout.desk_pop_dialog_adapter, parent, false);
