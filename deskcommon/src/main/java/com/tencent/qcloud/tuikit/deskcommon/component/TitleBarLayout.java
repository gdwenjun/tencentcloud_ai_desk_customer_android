...
public class TitleBarLayout extends LinearLayout implements ITitleBarLayout {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        inflate(context, R.layout.desk_timcommon_title_bar_layout, this);
        ...
        mAvatar = findViewById(R.id.page_title_avatar);
    ...
    public void setAvatar(String faceUr) {
        mAvatar.setVisibility(View.VISIBLE);
        RoundedCornersTransformation transformation = new RoundedCornersTransformation(30, 0);
