package com.tencent.qcloud.tuikit.deskcommon.component.dialog;

import static com.tencent.qcloud.deskcore.TUIConfig.TUICORE_SETTINGS_SP_NAME;
...
import com.tencent.qcloud.tuikit.deskcommon.BuildConfig;
...
public class TUIKitDialog {
    ...
    public TUIKitDialog builder() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.desk_view_dialog, null);
    ...
    public TUIKitDialog setPositiveButton(final OnClickListener listener) {
        setPositiveButton(TUIConfig.getAppContext().getString(com.tencent.qcloud.deskcore.R.string.sure), listener);
        return this;
    }
    ...
    public TUIKitDialog setNegativeButton(final OnClickListener listener) {
        setNegativeButton(TUIConfig.getAppContext().getString(com.tencent.qcloud.deskcore.R.string.cancel), listener);
        return this;
    }
