...
import com.tencent.qcloud.tuikit.deskcommon.TIMCommonService;
...
import com.tencent.qcloud.tuikit.deskcommon.util.TIMCommonLog;
...
public abstract class MessageContentHolder<T extends TUIMessageBean> extends MessageBaseHolder<T> {
    ...
    private void setUserIcon(T msg) {
        ...
        if(this.isCustomer() && !showAvatar){
            hideAvatar();
        }
    }
    private void hideAvatar(){
        leftUserIcon.setAlpha(0);
        rightUserIcon.setAlpha(0);
        ViewGroup.LayoutParams left_params = leftUserIcon.getLayoutParams();
        left_params.width = 1;
        left_params.height = 1;

        ViewGroup.LayoutParams right_params = rightUserIcon.getLayoutParams();
        right_params.width = 1;
        right_params.height = 1;
        rightUserIcon.setLayoutParams(right_params);
        leftUserIcon.setLayoutParams(left_params);
    }
    ...
    private void setupAvatar(Object faceUrl) {
        ...
        RequestBuilder<Drawable> errorRequestBuilder =
            Glide.with(itemView.getContext())
                .load(TUIThemeManager.getAttrResId(leftUserIcon.getContext(), com.tencent.qcloud.tuikit.deskcommon.R.attr.core_default_user_icon))
                .placeholder(TUIThemeManager.getAttrResId(leftUserIcon.getContext(), com.tencent.qcloud.tuikit.deskcommon.R.attr.core_default_user_icon))
