...
public class ImageSelectMinimalistActivity extends BaseMinimalistLightActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desk_core_minimalist_activity_image_select_layout);
        ...
        titleBarLayout.setTitle(getString(com.tencent.qcloud.deskcore.R.string.sure), ITitleBarLayout.Position.RIGHT);
    ...
    private void setSelectedStatus() {
        if (selected != null && data != null && data.contains(selected)) {
            ...
            titleBarLayout.getRightTitle().setTextColor(
                getResources().getColor(TUIThemeManager.getAttrResId(this, com.tencent.qcloud.deskcore.R.attr.core_primary_color)));
        } else {
    ...
    public static class ImageGridAdapter extends RecyclerView.Adapter<ImageGridAdapter.ImageViewHolder> {
        ...
        public ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.desk_core_select_image_item_layout, parent, false);
