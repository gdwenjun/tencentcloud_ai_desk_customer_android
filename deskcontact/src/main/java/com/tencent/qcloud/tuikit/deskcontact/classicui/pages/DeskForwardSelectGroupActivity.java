...
import com.tencent.qcloud.tuikit.deskcontact.bean.ConversationInfo;
...
import com.tencent.qcloud.tuikit.deskcontact.classicui.widget.ForwardContactSelectorAdapter;
...
public class DeskForwardSelectGroupActivity extends BaseLightActivity {
    private static final String TAG = DeskForwardSelectGroupActivity.class.getSimpleName();
    ...
    private void refreshSelectConversations() {
        ...
        if (mSelectConversationIcons == null || mSelectConversationIcons.size() == 0) {
            mSureView.setText(getString(com.tencent.qcloud.deskcore.R.string.sure));
            ...
            mSureView.setText(getString(com.tencent.qcloud.deskcore.R.string.sure) + "(" + mSelectConversationIcons.size() + ")");
        }
    }
