...
import com.tencent.qcloud.tuikit.deskcontact.minimalistui.widget.FriendProfileLayout;
...
public class DeskFriendProfileMinimalistActivity extends BaseMinimalistLightActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        layout.setOnButtonClickListener(new FriendProfileLayout.OnButtonClickListener() {
            ...
            public void onSetChatBackground() {
                ...
                Intent intent = new Intent(DeskFriendProfileMinimalistActivity.this, ImageSelectActivity.class);
