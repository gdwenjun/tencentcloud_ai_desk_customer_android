...
public class DeskStartGroupMemberSelectActivity extends BaseLightActivity {
    private static final String TAG = DeskStartGroupMemberSelectActivity.class.getSimpleName();
    ...
    public static class SelectedAdapter extends RecyclerView.Adapter<SelectedAdapter.SelectedViewHolder> {
        ...
        @Override
        public void onBindViewHolder(@NonNull DeskStartGroupMemberSelectActivity.SelectedAdapter.SelectedViewHolder holder, int position) {
