...
import com.tencent.qcloud.tuikit.deskcommon.component.activities.SelectionActivity;
...
public class DeskStartGroupChatActivity extends BaseLightActivity {
    private static final String TAG = DeskStartGroupChatActivity.class.getSimpleName();
    ...
    private DeskStartGroupMemberSelectActivity.SelectedAdapter selectedListAdapter;
    ...
    private void init() {
        ...
        selectedListAdapter = new DeskStartGroupMemberSelectActivity.SelectedAdapter();
