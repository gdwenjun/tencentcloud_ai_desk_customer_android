...
import com.tencent.qcloud.tuikit.deskcommon.component.activities.ImageSelectMinimalistActivity;
...
import com.tencent.qcloud.tuikit.deskcontact.bean.ChatInfo;
import com.tencent.qcloud.tuikit.deskcontact.bean.GroupInfo;
import com.tencent.qcloud.tuikit.deskcontact.bean.GroupMemberInfo;
...
public class DeskCreateGroupMinimalistActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = DeskCreateGroupMinimalistActivity.class.getSimpleName();
    ...
    private DeskStartGroupChatMinimalistActivity.GroupMemberSelectedAdapter groupMemberSelectedAdapter;
    ...
    public static class GroupTypeResultContract extends ActivityResultContract<String, String> {
        ...
        public Intent createIntent(@NonNull Context context, String type) {
            Intent intent = new Intent(context, DeskGroupTypeSelectMinimalistActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desk_contact_minimalist_create_group_layout);
    ...
    private void initGroupTypeContentView() {
        ...
        if (currentTheme == TUIThemeManager.THEME_LIVELY) {
            foregroundColor = getResources().getColor(com.tencent.qcloud.deskcore.R.color.core_primary_color_lively);
        } else if (currentTheme == TUIThemeManager.THEME_SERIOUS) {
            foregroundColor = getResources().getColor(com.tencent.qcloud.deskcore.R.color.core_primary_color_serious);
        } else {
            foregroundColor = getResources().getColor(com.tencent.qcloud.deskcore.R.color.core_primary_color_light);
        }
    ...
    private void initSelectedMemberList() {
        ...
        groupMemberSelectedAdapter = new DeskStartGroupChatMinimalistActivity.GroupMemberSelectedAdapter();
        groupMemberSelectedAdapter.setMembers(mGroupMembers);
        groupMemberSelectedAdapter.setSelectedMemberClickedListener(new DeskStartGroupChatMinimalistActivity.OnSelectedMemberClickedListener() {
            @Override
    ...
    private void showNotSupportDialog() {
        ...
        final int foregroundColor = getResources().getColor(TUIThemeManager.getAttrResId(this, com.tencent.qcloud.deskcore.R.attr.core_primary_color));
