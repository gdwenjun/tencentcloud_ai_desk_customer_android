...
public class DeskNewFriendApplicationDetailMinimalistActivity extends BaseMinimalistLightActivity {
    private static final String TAG = DeskNewFriendApplicationDetailMinimalistActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desk_contact_minimalist_new_friend_application_detail_activity);
