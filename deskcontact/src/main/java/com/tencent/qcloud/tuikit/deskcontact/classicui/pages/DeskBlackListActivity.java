...
public class DeskBlackListActivity extends BaseLightActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desk_contact_blacklist_activity);
    ...
    private void init() {
        ...
        mListView.setOnItemClickListener(new ContactListView.OnItemClickListener() {
            ...
            public void onItemClick(int position, ContactItemBean contact) {
                Intent intent = new Intent(DeskBlackListActivity.this, DeskFriendProfileActivity.class);
