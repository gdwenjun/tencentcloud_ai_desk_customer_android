...
public class DeskCreateGroupActivity extends BaseLightActivity implements View.OnClickListener {
    private static final String TAG = DeskCreateGroupActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desk_create_group_layout);
    ...
    public void onClick(View v) {
        if (v == groupAvatar || v == groupAvatarLayout) {
            ...
            Intent intent = new Intent(DeskCreateGroupActivity.this, ImageSelectActivity.class);
            ...
            intent.putExtra(ImageSelectActivity.PLACEHOLDER, com.tencent.qcloud.tuikit.deskcommon.R.drawable.core_default_user_icon_light);
            ...
            Intent intent = new Intent(this, DeskGroupTypeSelectActivity.class);
