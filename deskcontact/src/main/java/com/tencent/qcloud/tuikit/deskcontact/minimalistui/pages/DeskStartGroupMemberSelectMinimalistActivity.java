...
public class DeskStartGroupMemberSelectMinimalistActivity extends BaseMinimalistLightActivity {
    private static final String TAG = DeskStartGroupMemberSelectMinimalistActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desk_contact_minimalist_start_group_select_activity);
