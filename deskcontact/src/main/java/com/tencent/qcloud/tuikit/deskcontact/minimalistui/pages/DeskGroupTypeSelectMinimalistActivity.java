...
public class DeskGroupTypeSelectMinimalistActivity extends AppCompatActivity {
    private static final String TAG = DeskGroupTypeSelectMinimalistActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desk_contact_minimalist_group_type_select_layout);
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.desk_contact_minimalist_group_type_item, parent, false);
