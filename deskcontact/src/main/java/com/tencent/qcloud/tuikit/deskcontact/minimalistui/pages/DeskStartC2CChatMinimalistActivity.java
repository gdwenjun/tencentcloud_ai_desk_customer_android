...
public class DeskStartC2CChatMinimalistActivity extends AppCompatActivity {
    private static final String TAG = DeskStartC2CChatMinimalistActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        createGroupButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeskStartC2CChatMinimalistActivity.this, DeskStartGroupChatMinimalistActivity.class);
