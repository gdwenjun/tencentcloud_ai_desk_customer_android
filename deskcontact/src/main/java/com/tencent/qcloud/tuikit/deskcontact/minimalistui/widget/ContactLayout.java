...
import com.tencent.qcloud.tuikit.deskcommon.component.action.PopActionClickListener;
import com.tencent.qcloud.tuikit.deskcommon.component.action.PopMenuAction;
import com.tencent.qcloud.tuikit.deskcontact.R;
import com.tencent.qcloud.tuikit.deskcontact.minimalistui.interfaces.IContactLayout;
import com.tencent.qcloud.tuikit.deskcontact.minimalistui.pages.DeskAddMoreMinimalistDialogFragment;
import com.tencent.qcloud.tuikit.deskcontact.minimalistui.pages.DeskTUIContactMinimalistFragment;
...
public class ContactLayout extends LinearLayout implements IContactLayout {
    ...
    private DeskTUIContactMinimalistFragment.OnClickListener mClickListener = null;
    ...
    public void setOnClickListener(DeskTUIContactMinimalistFragment.OnClickListener listener) {
    ...
    private void initContactMenu() {
        ...
        PopActionClickListener popActionClickListener = new PopActionClickListener() {
            ...
            public void onActionClick(int index, Object data) {
                ...
                DeskAddMoreMinimalistDialogFragment addFragment = new DeskAddMoreMinimalistDialogFragment();
