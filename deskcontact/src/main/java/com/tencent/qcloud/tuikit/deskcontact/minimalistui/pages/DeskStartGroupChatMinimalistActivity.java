...
import com.tencent.qcloud.tuikit.deskcommon.component.RoundCornerImageView;
...
import com.tencent.qcloud.tuikit.deskcontact.minimalistui.widget.ContactAdapter;
...
public class DeskStartGroupChatMinimalistActivity extends AppCompatActivity {
    private static final String TAG = DeskStartGroupChatMinimalistActivity.class.getSimpleName();
    ...
    private void toCreateGroupChat() {
        ...
        Intent intent = new Intent(this, DeskCreateGroupMinimalistActivity.class);
    ...
    public static class GroupMemberSelectedAdapter extends RecyclerView.Adapter<GroupMemberSelectedAdapter.GroupMemberSelectedViewHolder> {
        ...
        public GroupMemberSelectedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new GroupMemberSelectedViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.desk_contact_create_group_list_selected_item, parent, false));
        }
