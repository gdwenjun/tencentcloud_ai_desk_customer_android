...
import com.tencent.qcloud.tuikit.deskchat.component.imagevideoscan.photoview.view.PhotoView;
import com.tencent.qcloud.tuikit.deskchat.component.imagevideoscan.video.VideoView;
import com.tencent.qcloud.tuikit.deskchat.component.imagevideoscan.video.proxy.IPlayer;
...
public class ImageVideoScanAdapter extends RecyclerView.Adapter<ImageVideoScanAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.desk_image_video_scan_item, parent, false);
