...
import com.tencent.qcloud.tuikit.deskchat.minimalistui.widget.ChatView;
...
public abstract class DeskTUIBaseChatMinimalistFragment extends Fragment {
    private static final String TAG = DeskTUIBaseChatMinimalistFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        baseView = inflater.inflate(R.layout.desk_chat_minimalist_fragment, container, false);
        return baseView;
    }

    protected void initView() {
        chatView = baseView.findViewById(R.id.chat_layout);
        chatView.initDefault(DeskTUIBaseChatMinimalistFragment.this);
        ...
        chatView.getInputLayout().setOnInputViewListener(new InputView.OnInputViewListener() {
            ...
            public void onStartGroupMemberSelectActivity() {
                ...
                TUICore.startActivityForResult(DeskTUIBaseChatMinimalistFragment.this, "StartGroupMemberSelectMinimalistActivity", param, result -> {
    ...
    protected void selectConversationsToForwardMessages(Supplier<List<TUIMessageBean>> messageBeans, int forwardMode) {
        TUICore.startActivityForResult(DeskTUIBaseChatMinimalistFragment.this, "TUIForwardSelectMinimalistActivity", null, result -> {
