package com.tencent.qcloud.tuikit.deskchat.minimalistui.widget.message;
...
import com.tencent.qcloud.tuikit.deskcommon.minimalistui.widget.message.MessageBaseHolder;
...
import com.tencent.qcloud.tuikit.deskchat.minimalistui.page.DeskTUIForwardChatMinimalistActivity;
import com.tencent.qcloud.tuikit.deskchat.minimalistui.widget.message.reply.ReplyDetailsView;
...
public class ChatReplyDialogFragment extends DialogFragment implements IReplyMessageHandler {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.desk_chat_reply_dialog_layout, container);
        ...
        if (originMessage != null) {
            ...
            if (repliesBean != null) {
                ...
                title.setText(String.format(
                    Locale.US, getResources().getString(com.tencent.qcloud.tuikit.deskcommon.R.string.chat_reply_num), repliesBean.getRepliesSize()));
            }
