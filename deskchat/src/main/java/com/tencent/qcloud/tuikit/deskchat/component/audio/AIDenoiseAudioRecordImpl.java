package com.tencent.qcloud.tuikit.deskchat.component.audio;
            ...
            switch (errorCode) {
                case TUIConstants.TUICalling.ERROR_NONE:
                    ...
                    handler.postDelayed(() -> {
                        ...
                        stopRecord();
                        ToastUtil.toastLongMessage(TUIChatService.getAppContext().getString(com.tencent.qcloud.tuikit.deskchat.R.string.record_limit_tips));
