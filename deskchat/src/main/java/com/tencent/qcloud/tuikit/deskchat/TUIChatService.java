...
import com.tencent.qcloud.tuikit.deskcommon.bean.Emoji;
import com.tencent.qcloud.tuikit.deskcommon.bean.FaceGroup;
...
import com.tencent.qcloud.tuikit.deskchat.interfaces.GroupChatEventListener;
import com.tencent.qcloud.tuikit.deskchat.interfaces.IBaseMessageSender;
import com.tencent.qcloud.tuikit.deskchat.interfaces.IMessageRecyclerView;
import com.tencent.qcloud.tuikit.deskchat.interfaces.NetworkConnectionListener;
...
import com.tencent.qcloud.tuikit.deskchat.util.DataStoreUtil;
import com.tencent.qcloud.tuikit.deskchat.util.OfflinePushInfoUtils;
...
public class TUIChatService implements TUIInitializer, ITUIService, ITUINotification {
    ...
    private void loadBuildInFaces() {
        ThreadUtils.execute(() -> {
            ...
            int emojiSize = getAppContext().getResources().getDimensionPixelSize(com.tencent.qcloud.tuikit.deskchat.R.dimen.chat_default_load_emoji_size);
            ...
            emojiFaceGroup.setFaceGroupIconUrl(com.tencent.qcloud.tuikit.deskchat.R.drawable.tuiemoji_default_emoji_group_icon);
