...
import com.tencent.qcloud.tuikit.deskchat.bean.GroupMessageReadMembersInfo;
import com.tencent.qcloud.tuikit.deskchat.bean.message.MergeMessageBean;
import com.tencent.qcloud.tuikit.deskchat.interfaces.IMessageDetailListener;
import com.tencent.qcloud.tuikit.deskchat.minimalistui.MinimalistUIService;
import com.tencent.qcloud.tuikit.deskchat.minimalistui.widget.message.viewholder.MessageViewHolderFactory;
import com.tencent.qcloud.tuikit.deskchat.presenter.MessageReceiptPresenter;
import com.tencent.qcloud.tuikit.deskchat.util.TUIChatLog;

import java.util.ArrayList;
import java.util.List;

public class DeskMessageDetailMinimalistActivity extends BaseMinimalistLightActivity implements IMessageDetailListener {
    private static final String TAG = DeskMessageDetailMinimalistActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desk_chat_minimalist_message_detail_layout);
    ...
    static class MemberAdapter extends RecyclerView.Adapter<MemberAdapter.MemberViewHolder> {
        ...
        public MemberViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.desk_chat_minimalist_group_receipt_member_item, parent, false);
