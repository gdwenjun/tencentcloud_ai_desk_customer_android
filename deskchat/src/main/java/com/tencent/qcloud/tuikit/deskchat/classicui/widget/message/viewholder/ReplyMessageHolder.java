...
public class ReplyMessageHolder extends MessageContentHolder {
    ...
    public ReplyMessageHolder(View itemView) {
        ...
        replyContentTv.setHighlightColor(itemView.getResources().getColor(com.tencent.qcloud.tuikit.deskcommon.R.color.timcommon_text_highlight_color));
    }

    @Override
    public int getVariableLayout() {
        return R.layout.desk_message_adapter_content_reply;
    }
    ...
    private void setThemeColor(TUIMessageBean messageBean) {
        ...
        if (isCustomer() && messageBean.isSelf()) {
            senderNameTv.setTextColor(Color.parseColor("#ecf0f1"));
            replyContentTv.setTextColor(itemView.getContext().getResources().getColor(R.color.white));
        }
    }
    ...
    private void performText(ReplyMessageBean replyMessageBean, String originAbstract) {
        ...
        if (isCustomer()) {
            textReplyQuoteView.setTextColor(Color.parseColor("#ecf0f1"));
        }
    }
