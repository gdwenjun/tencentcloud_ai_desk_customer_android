...
public class DeskMessageReceiptDetailActivity extends BaseLightActivity {
    private static final String TAG = DeskMessageReceiptDetailActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desk_msg_receipt_detail_layout);
        ...
        readTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                readTitleTv.setTextColor(getResources().getColor(
                    TUIThemeManager.getAttrResId(DeskMessageReceiptDetailActivity.this, com.tencent.qcloud.deskcore.R.attr.core_primary_color)));
    ...
    static class MemberAdapter extends RecyclerView.Adapter<MemberAdapter.MemberViewHolder> {
        ...
        public MemberViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.desk_group_receipt_member_item, parent, false);
