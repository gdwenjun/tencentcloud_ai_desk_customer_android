package com.tencent.qcloud.tuikit.deskchat.classicui.component.popmenu;
...
public class ChatPopMenu {
    ...
    public ChatPopMenu(Context context) {
        ...
        popupView = LayoutInflater.from(context).inflate(R.layout.desk_chat_pop_menu_layout, null);
    ...
    class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.MenuItemViewHolder> {
        ...
        public MenuAdapter.MenuItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.desk_chat_pop_menu_item_layout, parent, false);
