package com.tencent.qcloud.tuikit.deskchat.minimalistui.component.dialog;
...
public class ChatBottomSelectSheet {
    ...
    public ChatBottomSelectSheet(Context context) {
        View view = View.inflate(context, R.layout.desk_chat_minimalist_bottom_select_sheet, null);
        ...
        listAdapter = new ArrayAdapter<>(context, R.layout.desk_chat_minimalist_bottom_sheet_item, R.id.sheet_item, selectList);
