package com.tencent.qcloud.tuikit.deskchat.config;
...
public class GeneralConfig {
    ...
    private int chatBgSourceID = -1;

    public void setChatBgSourceID(int id){
        this.chatBgSourceID = id;
    }

    public int getChatBgSourceID(){
        return  this.chatBgSourceID;
    }

    /**
     * Set if show avatar in TUIChat
     */
    public void setIsShowAvatar(boolean show){
        this.showAvatar = show;
    }
    /**
     * get if show avatar in TUIChat
     */
