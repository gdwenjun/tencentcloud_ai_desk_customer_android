package com.tencent.qcloud.tuikit.deskchat.component.pinned;
...
import com.tencent.qcloud.tuikit.deskchat.interfaces.IGroupPinnedView;
...
public class GroupPinnedView extends FrameLayout implements IGroupPinnedView {
    ...
    private void init(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.desk_chat_group_pinned_view_layout, this);
    ...
    public static class PinnedMessageListPopWindow {
        ...
        public PinnedMessageListPopWindow(Context context) {
            contentView = LayoutInflater.from(context).inflate(R.layout.desk_chat_group_pinned_view_dialog_layout, null);
        ...
        class PinnedMessageListAdapter extends RecyclerView.Adapter<PinnedMessageViewHolder> {
            ...
            public PinnedMessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.desk_chat_group_pinned_item_view_layout, parent, false);
