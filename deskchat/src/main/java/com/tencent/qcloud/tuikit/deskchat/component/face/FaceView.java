package com.tencent.qcloud.tuikit.deskchat.component.face;
...
import com.tencent.qcloud.tuikit.deskcommon.component.face.RecentEmojiManager;
...
public class FaceView extends FrameLayout {
    ...
    private void init(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.desk_chat_face_view_layout, this);
        ...
        emojiTabLayoutMediator = new TabLayoutMediator(emojiTabs, emojiPages, new TabLayoutMediator.TabConfigurationStrategy() {
            ...
            public void onConfigureTab(@NonNull TabLayout.Tab tab, int position) {
                View tabView = LayoutInflater.from(context).inflate(R.layout.desk_chat_face_tab_item_layout, null);
    ...
    private void showFaceDetail(ChatFace chatFace) {
        View contentView = LayoutInflater.from(getContext()).inflate(R.layout.desk_chat_face_detail_layout, null);
