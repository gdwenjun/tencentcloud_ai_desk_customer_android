package com.tencent.qcloud.tuikit.deskchat.minimalistui.widget.messagepopmenu;
...
import com.tencent.qcloud.tuikit.deskchat.util.BlurUtils;
...
public class ChatPopActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desk_chat_minimalist_pop_menu_layout);
    ...
    class MenuActionAdapter extends RecyclerView.Adapter<MenuActionAdapter.MenuItemViewHolder> {
        ...
        public MenuActionAdapter.MenuItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.desk_chat_minimalist_pop_menu_action_item_layou, parent, false);
