...
import com.tencent.qcloud.tuikit.deskchat.model.ChatFileDownloadProvider;
...
public class FileMessageHolder extends MessageContentHolder {
    ...
    public int getVariableLayout() {
        return R.layout.desk_message_adapter_content_file;
    }
    ...
    public void layoutVariableViews(final TUIMessageBean msg, final int position) {
        ...
        if (isForwardMode || isReplyDetailMode) {
            ...
            if (msg.isSelf()) {
                ...
                if (isCustomer()) {
                    fileNameText.setTextColor(this.itemView.getContext().getResources().getColor(R.color.white));
                    fileSizeText.setTextColor(this.itemView.getContext().getResources().getColor(R.color.reply_preview_text_color));
                    fileStatusText.setTextColor(this.itemView.getContext().getResources().getColor(R.color.reply_preview_text_color));
                }
            } else {
        ...
        if (drawable != null) {
            if (progressDrawable == null) {
                ...
                progressDrawable.setPaintColor(
                    context.getResources().getColor(TUIThemeManager.getAttrResId(context, com.tencent.qcloud.deskcore.R.attr.core_bubble_bg_color)));
