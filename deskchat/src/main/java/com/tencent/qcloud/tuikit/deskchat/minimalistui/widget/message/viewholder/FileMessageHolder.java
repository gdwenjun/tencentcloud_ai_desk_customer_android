...
public class FileMessageHolder extends MessageContentHolder {
    ...
    public int getVariableLayout() {
        return R.layout.desk_minimalist_message_adapter_content_file;
    }
    ...
    public void layoutVariableViews(final TUIMessageBean msg, final int position) {
        ...
        if (isFileExists) {
            ...
            fileStatusImage.setImageResource(com.tencent.qcloud.tuikit.deskcommon.R.drawable.chat_minimalist_file_download_icon);
