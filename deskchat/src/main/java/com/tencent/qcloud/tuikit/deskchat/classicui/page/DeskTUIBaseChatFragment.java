...
public abstract class DeskTUIBaseChatFragment extends Fragment {
    private static final String TAG = DeskTUIBaseChatFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        baseView = inflater.inflate(R.layout.desk_chat_fragment, container, false);
    ...
    protected void initView() {
        ...
        chatView.initDefault(DeskTUIBaseChatFragment.this);
    ...
    private void setChatViewListener() {
        ...
        chatView.getInputLayout().setOnInputViewListener(new InputView.OnInputViewListener() {
            ...
            public void onStartGroupMemberSelectActivity() {
                ...
                TUICore.startActivityForResult(DeskTUIBaseChatFragment.this, "StartGroupMemberSelectActivity", param, result -> {
    ...
    private void selectConversationsToForwardMessages(Supplier<List<TUIMessageBean>> messageBeanSupplier, int forwardMode) {
        ...
        TUICore.startActivityForResult(DeskTUIBaseChatFragment.this, "TUIForwardSelectActivity", null, new ActivityResultCallback<ActivityResult>() {
            @Override
