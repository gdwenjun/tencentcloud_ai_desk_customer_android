...
import com.tencent.qcloud.tuikit.deskchat.classicui.widget.message.viewholder.MessageHeadHolder;
import com.tencent.qcloud.tuikit.deskchat.classicui.widget.message.viewholder.MessageViewHolderFactory;
...
public class MessageAdapter extends RecyclerView.Adapter implements IMessageAdapter, ICommonMessageAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (holder instanceof MessageContentHolder) {
            ...
            messageContentHolder.showAvatar = TUIChatConfigs.getGeneralConfig().getIsShowAvatar();
        }
        return holder;
    }
